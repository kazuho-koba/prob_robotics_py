...
class Camera(IdealCamera):
    def __init__(self, env_map,
                 ...
                 oversight_prob=0.0, occulusion_prob=0.0):
    ...
    # add some noises to observed values
    ...
    # add a function to implement oversights
    ...
    # add a function to implement occulusions
